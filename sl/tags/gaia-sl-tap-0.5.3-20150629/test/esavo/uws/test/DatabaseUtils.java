...
public class DatabaseUtils {
	...
	public static final String QUERY_SELECT_JOB = "SELECT owner_id, session_id, phase_id, quote, start_time, end_time, wait_for_stop, relative_path "+
			"FROM uws_schema.jobs WHERE job_id = ''{0}''";
	
	public static final String QUERY_INSERT_JOB = "INSERT INTO uws_schema.jobs "+
	...
	public static final String QUERY_JOB_OLDER_THAN = "SELECT job_id "+
			"FROM uws_schema.jobs WHERE owner_id = ''{0}'' AND "+
			"start_time < {1} AND job_id LIKE ''%{2}''";

	//execution phase
	public static final String QUERY_UPDATE_JOB_EXEC_PHASE = "UPDATE uws_schema.jobs SET {0} = {1} WHERE job_id = {2}";
	...
	public static final String QUERY_SELECT_OWNER = "SELECT auth_name, pseudo "+
			"FROM uws_schema.owners WHERE owner_id = ''{0}''";
	...
	public static final String QUERY_SELECT_PARAMETERS = "SELECT parameter_id, data_type, string_representation "+
			"FROM uws_schema.job_parameters WHERE job_id = ''{0}''";
	
	public static final String QUERY_INSERT_PARAMETERS = "INSERT INTO uws_schema.job_parameters "+
	...
	public static final String QUERY_SELECT_ERROR_SUMMARY = "SELECT message, type, details "+
			"FROM uws_schema.error_summary WHERE job_id = ''{0}''";
	
	public static final String QUERY_INSERT_ERROR_SUMMARY = "INSERT INTO uws_schema.error_summary "+
	...
	public static final String QUERY_SELECT_RESULTS = "SELECT result_id, href, type, mime_type, size, rows "+
			"FROM uws_schema.results where job_id = ''{0}''";
	
	public static final String QUERY_INSERT_RESULTS = "INSERT INTO uws_schema.results "+
	 ...
	 * <ul>
	 * <li>insert into uws_schema.jobs () values ()
	 * <li>insert into 
	 * </ul>
	 * @param job
	 */
	public static void createValidJobInsertionQueries(UwsJob job, DummyDatabaseConnection connection){
		...
		DummyData jobInsertData = createSingleInsertOrUpdateData();
		...
		DummyData jobExistsData = createJobExistsData(jobid);
		connection.setDataForQuery(jobExistsQuery, jobExistsData);
	}
	
	public static DummyData createSingleInsertOrUpdateData(){
	...
	public static void createDefaultParametersData(DummyDatabaseConnection connection, UwsJob job){
		String query;
		...
		DummyData d = createSingleInsertOrUpdateData();
	...
	public static DummyData createDummyData(String[] columnNames,
			String[][] results) {
		DummyData d = new DummyData();
		d.setColumnNames(columnNames);
		d.setData(results);
	...
	public static DummyData createSingleJobResultsData(String resultid, String href, String type, String mimeType, String size, String rows){
		return createSingleRowDummyData(COLUMN_NAMES_QUERY_RESULTS, new String[]{resultid, href, type, mimeType, size, rows});
	}
	
	public static DummyData createSingleErrorSummaryData(String message, String type, String details){
...
//	}
	...
	public static DummyData createSingleOwnerData(String authName, String pseudo){
		return createSingleRowDummyData(COLUMN_NAMES_QUERY_OWNER, new String[]{authName, pseudo});
	}
	
	public static DummyData createSingleJobData(String ownerid, String session, String phaseid, String quote, String startTime, String endTime, String waitForStop, String locationid){
	...
	public static DummyData createJobExistsData(String jobid){
		return createSingleRowDummyData(COLUMN_NAMES_QUERY_JOB_EXISTS, new String[]{jobid});
	}
	
	public static DummyData createJobLocationData(String location){
		return createSingleRowDummyData(COLUMN_NAMES_QUERY_JOB_LOCATION, new String[]{location});
	}
	
	public static DummyData createTapMetaInfoData(List<List<String>> results){
	...
	public static void createOwnerUpdateQueries(DummyDatabaseConnection[] dbConn, UwsJobOwner owner, String schemaName, String tableName){
		Map<String, DummyData> queries = DatabaseUtils.createOwnerUpdateQueries(owner, schemaName, tableName);
		for(Entry<String, DummyData> e: queries.entrySet()){
			for(DummyDatabaseConnection d: dbConn){
				d.setDataForQuery(e.getKey(), e.getValue());
			}
		}
	}
	
	public static Map<String, DummyData> createOwnerUpdateQueries(UwsJobOwner owner, String schemaName, String tableName){
		Map<String,DummyData> queries = new HashMap<String, DummyData>();
		
		List<String> columnNames = new ArrayList<String>();
		columnNames.add("tap_schema.db_table_usage");
		String[] singleRowData = {"0"};
		DummyData data = DatabaseUtils.createSingleRowDummyData(columnNames, singleRowData);
		String query = "SELECT tap_schema.db_table_usage('"+schemaName+"','"+tableName+"')";
		queries.put(query, data);
		
		columnNames.clear();
		columnNames.add("tap_schema.db_user_usage");
		singleRowData[0] = "0";
		data = DatabaseUtils.createSingleRowDummyData(columnNames, singleRowData);
		query = "SELECT tap_schema.db_user_usage('"+owner.getId()+"')";
		queries.put(query, data);
		...
		data = DatabaseUtils.createSingleInsertOrUpdateData();
		queries.put(query, data);
