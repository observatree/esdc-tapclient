...
public class ManagerUtils {
	...
	public static void writeError(HttpServletResponse response, int httpErrorCode, Throwable t) throws IOException {
		...
		if(t == null){
			...
			pw.println(Templates.getErrorMessage(GENERIC_ERROR_MSG, t.getMessage(), Templates.getPlainText(Utils.dumpStackTrace(t))));
		}
		pw.flush();
	}
	...
	public static void writeError(HttpServletResponse response, int httpErrorCode, String error, Throwable t) throws IOException{
		...
		if(t == null){
			...
			pw.println(Templates.getErrorMessage(GENERIC_ERROR_MSG, error + "<br/>" + t.getMessage(), Templates.getPlainText(Utils.dumpStackTrace(t))));
		}
		pw.flush();
	}
