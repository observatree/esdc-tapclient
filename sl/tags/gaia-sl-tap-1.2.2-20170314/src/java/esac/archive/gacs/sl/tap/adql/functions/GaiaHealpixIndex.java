...
public class GaiaHealpixIndex extends UserDefinedFunction {
	
	public static final String TAP_ADQL_FUNCTION_GAIA_HEALPIX_INDEX="gaia_healpix_index";
	
	private String name;
    private ADQLOperand[] params;

    public GaiaHealpixIndex(String name, ADQLOperand[] params) {
